  ...
  const steps = [
    {
      icon: UserCheck,
      title: "1. Inscription",
      desc: "Constitution simplifiée de votre dossier en ligne ou en agence.",
    },
    {
      icon: BookOpen,
      title: "2. Code de la Route",
      desc: "Entraînement théorique avec nos séries et cours interactifs.",
    },
    {
      icon: Car,
      title: "3. Leçons Pratiques",
      desc: "Apprentissage sur la route avec votre moniteur référent.",
    },
    {
      icon: Award,
      title: "4. Examen & Permis",
      desc: "Passage de l’épreuve pratique et délivrance du permis.",
    },
  ];
